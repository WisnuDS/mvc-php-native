...
<div id="popLog" class="popUpLog">
    <form class="popUp-content animate">
        <div class="thisContainer">
            <span class="thisClose" onclick="thisClickedLogC()"><b>X</b></span>
            <h2 for="titlePop"><b><center>Login</center></b></h2>
            ...
            <button type="submit" class="btn-lr">Login</button>
        </div>
    </form>
</div>
<div id="popReg" class="popUpReg">
    <form class="popUp-content animate">
        <div class="thisContainer">
            <span class="thisClose" onclick="thisClickedRegC()"><b>X</b></span>
            <h2 for="titlePop"><b><center>Register</center></b></h2>
        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    <h2 class="ftco-heading-2">PASAR TRADISIONAL</h2>
                    <p>The market is one of various systems, institutions, procedures, social relations and infrastructure where businesses sell goods, services, and labor to people in exchange for money.</p>
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon icon-map-marker"></span><span class="text">Villa Tegal Besar A2, Kaliwates - Jember. Indonesia</span></li>
                            <li><a href="#"><span class="icon icon-phone"></span><span class="text">089654863414</span></a></li>
                            <li><a href="#"><span class="icon icon-envelope"></span><span class="text">info@pasartradisional.com</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    Copyright &copy;2020 All rights reserved | Pasar Tradisional</a>
