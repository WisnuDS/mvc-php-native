    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="<?=BASE_URL?>__Admin/logout">Logout</a>
            </div>
        </div>
    </div>
</div>
...
<!-- Core plugin JavaScripsbadmin/t-->
<script src="<?=BASE_URL?>sbadmin/vendor/jquery-easing/jquery.easing.min.js"></script>

<!-- Custom scripts for alsbadmin/l pages-->
<script src="<?=BASE_URL?>sbadmin/js/sb-admin-2.js"></script>
